...
namespace Inheritance17
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var grandTotalShipping = CalculateShipping(shippingItems);
            Console.WriteLine($"Total shipping cost: {grandTotalShipping.ToString("C0")}");

            CompleteTransaction(items);

            double totalCost = itemCost + taxAmount + grandTotalShipping;
